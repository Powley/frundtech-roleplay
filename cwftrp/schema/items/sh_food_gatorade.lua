...
local ITEM = Clockwork.item:New("portion_base"); -- Derives from the ammo_base item in Clockwork.
	ITEM.category = "Food"
	ITEM.name = "Gatorade"; -- What is the name of this item?
	ITEM.cost = 15; -- How much does this item cost?
	ITEM.model = "models/warz/consumables/gatorade.mdl"; -- What is the model of this item?
	...
	ITEM.description = "Branded energy juice, probably packs a punch."; -- A short description of the item.
	ITEM.useText = "Drink";
	ITEM.batch = 1;
	ITEM.pieces = 1;
ITEM:Register();
