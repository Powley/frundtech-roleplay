...
local ITEM = Clockwork.item:New("portion_base"); -- Derives from the ammo_base item in Clockwork.
	ITEM.category = "Food"
	ITEM.name = "SPAM"; -- What is the name of this item?
	ITEM.cost = 15; -- How much does this item cost?
	ITEM.model = "models/warz/consumables/can_spam.mdl"; -- What is the model of this item?
	...
	ITEM.description = "It's like ham, but it's not okay?"; -- A short description of the item.
	ITEM.useText = "Eat";
	ITEM.batch = 1;
	ITEM.pieces = 2;
ITEM:Register();
