...
-- Called when the item is taken from the player.
...
if (CLIENT) then
	function ITEM:GetClientSideInfo()
		...
		if (self:GetData("IsEquipped")) then
			clientSideInfo = Clockwork.kernel:AddMarkupLine(clientSideInfo, "Equipped: Yes");
		else
			clientSideInfo = Clockwork.kernel:AddMarkupLine(clientSideInfo, "Equipped: No");
		end;
